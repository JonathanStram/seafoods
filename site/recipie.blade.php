        ...
        <div class="container">
            <div class="tab-section">
                <ul class="tab-button-area">
                    <li class="tab-button active">Популярные</li>
                    <li class="tab-button">Новые</li>
                    <li class="tab-button">Рекомендуем</li>
                </ul>

                <div class=" portfolio-container-wrapper">
                    <div id="on-items-bucket"></div>
                    <div id="off-items-bucket" class="portfolio-container show">
                        <div class="portfolio__item" data-category="popular">
                            <div class="portfolio__card">
                                <img class="portfolio__image" src="./img/recepie1.png" alt="portfolio">
                                <button class="order-btn ">Show</button>

                            </div>
                            <div class="portfolio__text">
                                <h2>Жареные креветки с перцем и чесноком</h2>
                            </div>
                            <div class="portfolio__rait">

                            </div>
                        </div>
                        <div class="portfolio__item" data-category="popular">
                            <div class="portfolio__card">
                                <img class="portfolio__image" src="./img/recepie2.png" alt="portfolio">
                                <button class="order-btn ">Show</button>
                        ...
                        <div class="portfolio__item" data-category="popular">
                            <div class="portfolio__card">
                                <img class="portfolio__image" src="./img/recepie4.png" alt="portfolio">
                                <button class="order-btn ">Show</button>
                    ...
                    <div id="on-items-bucket"></div>
                    <div id="off-items-bucket" class="portfolio-container">
                        <div class="portfolio__item" data-category="new">
                            <div class="portfolio__card">
                                <img class="portfolio__image" src="./img/recepie2.png" alt="portfolio">
                                <button class="order-btn ">Show</button>
                            </div>
                        ...
                        <div class="portfolio__item" data-category="recomended">
                            <div class="portfolio__card">
                                <img class="portfolio__image" src="./img/recepie2.png" alt="portfolio">
                                <button class="order-btn ">Show</button>
                    ...
                    <div id="on-items-bucket"></div>
                    <div id="off-items-bucket-1" class="portfolio-container">
                        <div class="portfolio__item" data-category="recomended">
                            <div class="portfolio__card">
                                <img class="portfolio__image" src="./img/recepie3.png" alt="portfolio">
                                <button class="order-btn ">Show</button>

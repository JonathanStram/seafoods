  ...
  <section id="first-screen">
    <div class="container">
      <div class="sm-container">
        ...
        <!-- Swiper -->
        <div class="swiper-wrapper__main">
          <div class="swiper-container gallery-top">
            <div class="swiper-wrapper">
              <div class="swiper-slide"><img src="./img/shrimps.jpg" alt=""></div>
              <div class="swiper-slide"><img src="./img/solomon.jpg" alt=""></div>
              <div class="swiper-slide"><img src="./img/solomon2.jpg" alt=""></div>
            </div>
          </div>
          <div class="swiper-container gallery-thumbs">
            <div class="swiper-wrapper">
              <div class="swiper-slide">Креветка Тигровая</div>
              <div class="swiper-slide">Лосось Норвежский</div>
              <div class="swiper-slide">Креветка Тигровая</div>
            </div>
          </div>
        </div>
      </div>
      <div class="sf-lang-buttons">
        <img src="./img/svg/RU.svg" alt="">
        <img src="./img/svg/EN.svg" alt="">
        <img src="./img/svg/UA.svg" alt="">
      </div>
      <div class="sf-social-icons">
        <a href="#"><img src="./img/svg/Inst.svg" alt=""></a>
        <a href="#"><img src="./img/svg/Vector.svg" alt=""></a>
        <a href="#"><img src="./img/svg/Tellegram.svg" alt=""></a>
      </div>
      <img class="sf-scroll" src="./img/svg/Scroll.svg" alt="">
      ...
      <div class="benefits">
        <div class="benefits-card">
          ...
          <div class="benefits-card__description">
            <h3>Гарантия свежести РЫБЫ 5 дней</h3>
          </div>
        </div>
        <div class="benefits-card">
          <div class="benefits-card__img">
        ...
        <div class="benefits-card">
          ...
          <div class="benefits-card__description">
            <h3>выбор напитков под ваш вкус</h3>
          </div>
        </div>
        <div class="benefits-card">
          <div class="benefits-card__img">
          ...
          <div class="benefits-card__description">
            <h3>морепродукты прямо с океана</h3>
          </div>
        </div>
      </div>
    </div>
  </section>
  <section class="sf-recomentation">
    <div class="container">
      <div class="sf-recomendation-wrap">
        <div class="sf-heading">
          <h1>Рецепты и рекомендации</h1>
          <h2>У нас вы узнаете рецепты лучших шеф - поваров мира</h2>
        </div>
        <div class="sf-recepie-wrap">
          <div class="sf-recepie-card">
            <div class="sf-recepie-card__img">
              <img src="./img/recipie-csrd-img-1.png" alt="">
            </div>
            <div class="sf-recepie-card__text">
              <div class="container">
                <h4>Креветки по-тайски</h4>
                <hr>
                <ul>
          ...
          <div class="sf-recepie-card">
            <div class="sf-recepie-card__img">
              <img src="./img/recipie-csrd-img-2.png" alt="">
            </div>
            <div class="sf-recepie-card__text">
              <div class="container">
                <h4>Креветки по-тайски</h4>
          ...
          <div class="sf-recepie-card">
            <div class="sf-recepie-card__img">
              <img src="./img/recipie-csrd-img-3.png" alt="">
            </div>
            <div class="sf-recepie-card__text">
              <div class="container">
                <h4>Креветки по-тайски</h4>
          ...
          <div class="sf-recepie-card">
            <div class="sf-recepie-card__img">
              <img src="./img/recipie-csrd-img-4.png" alt="">
            </div>
            <div class="sf-recepie-card__text">
              <div class="container">
                <h4>Креветки по-тайски</h4>
          ...
          <div class="sf-recepie-card">
            <div class="sf-recepie-card__img">
              <img src="./img/recipie-csrd-img-5.png" alt="">
            </div>
            <div class="sf-recepie-card__text">
              <div class="container">
                <h4>Креветки по-тайски</h4>
